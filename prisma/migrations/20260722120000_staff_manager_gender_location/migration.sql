...
INSERT INTO "new_staff" ("avatarKey", "code", "createdAt", "dateOfBirth", "departmentId", "email", "firstWorkDate", "fullName", "id", "isActive", "phone", "roleId", "teamId", "title", "updatedAt") SELECT "avatarKey", "code", "createdAt", "dateOfBirth", "departmentId", "email", "firstWorkDate", "fullName", "id", "isActive", "phone", "roleId", "teamId", "title", "updatedAt" FROM "staff";
DROP TABLE "staff";
