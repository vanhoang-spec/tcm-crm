-- AlterTable
ALTER TABLE "vendor_payment" ADD COLUMN "overCapNote" TEXT;
...
INSERT INTO "new_finance_cost_line" ("amount", "createdAt", "id", "isStale", "itemCode", "itemName", "lineKey", "netAmount", "projectId", "sectionCode", "sectionName", "sort", "sourceRevNo", "specs", "updatedAt", "vendorId") SELECT "amount", "createdAt", "id", "isStale", "itemCode", "itemName", "lineKey", "netAmount", "projectId", "sectionCode", "sectionName", "sort", "sourceRevNo", "specs", "updatedAt", "vendorId" FROM "finance_cost_line";
