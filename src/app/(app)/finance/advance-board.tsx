  ...
  return (
    <div className="overflow-x-auto">
      <div className="min-w-[720px]">
        {/* Header */}
        <div className="grid grid-cols-[1.4fr_1.6fr_1fr_1fr_1fr_auto] gap-2 border-b border-border pb-1.5 text-[11px] font-medium text-muted-foreground">
...
function LineRow({
  ...
  return (
    <div className={cn("border-b border-border/60", line.isStale && "opacity-70")}>
      <div className="grid grid-cols-[1.4fr_1.6fr_1fr_1fr_1fr_auto] items-center gap-2 py-1.5 text-sm">
        ...
        <span className="text-right tabular-nums text-foreground">{formatNumber(line.amount, locale)}</span>
    ...
    <form action={formAction} className="space-y-2 rounded-lg border border-dashed border-border-strong p-2.5">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        <label className="text-[11px] text-muted-foreground">
          ...
          <input name="amount" type="number" step="any" min={1} placeholder={t("amountPlaceholder")} className={input} />
        </label>
